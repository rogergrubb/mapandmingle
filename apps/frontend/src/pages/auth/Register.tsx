...
import { Eye, EyeOff, Mail, Lock, User, AtSign, ArrowRight, Loader2, Check } from 'lucide-react';
...
export default function Register() {
  ...
  return (
    <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
      ...
      <p className="text-gray-500 mb-6">Join the community and start mingling</p>
